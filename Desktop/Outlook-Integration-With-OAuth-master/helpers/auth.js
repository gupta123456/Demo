...
const db = require('/home/syed/Desktop/node-tutorial-master/helpers/mysqlservices.js');

function saveValuesToDatabase(token, user, res) {
  let sqlQuery = 'INSERT INTO outlookCred  VALUES(\'' + user.name.toString() + '\' , \'' + token.token.access_token.toString() + '\', \'' + token.token.refresh_token.toString() + '\')';
